...
model = AutoModelForCausalLM.from_pretrained(model_id, quantization_config=bnb_config, device_map={"":0}) # device_map="auto"
...
adapter_model = f"arslankhan/{base_model_name}-fine-tuned-adapters"  #adjust 'arslankhan' to your HuggingFace organisation
new_model = f"arslankhan/{base_model_name}-fine-tuned" #adjust 'arslankhan' to your HuggingFace organisation
